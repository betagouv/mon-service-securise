...
export const mesuresV2 = {
  ...
  'RGPD.4': {
    ...
    descriptionLongue:
      'Informer clairement les personnes lors de la collecte de leurs données de manière à ce qu’elles puissent :<br>- connaître la raison de la collecte des différentes données les concernant ;<br>- comprendre le traitement qui sera fait de leurs données ;<br>- être assurées de la maîtrise de leurs données, notamment via l’exercice de leurs droits. La liste complète des informations à fournir <a href="https://www.cnil.fr/fr/reglement-europeen-protection-donnees/chapitre3#Article13" target="_blank" rel="noopener">est disponible ici</a>.<br><br>Cette mesure permet aux personnes concernées de conserver la maîtrise de leurs données. Cela suppose qu’elles soient clairement informées de l’utilisation qui sera faite de leurs données. Les personnes doivent également être informées de leurs droits et des modalités d’exercice de ces droits. Plus d’information <a href="https://www.cnil.fr/fr/conformite-rgpd-information-des-personnes-et-transparence" target="_blank" rel="noopener">ici</a>.',
    categorie: 'gouvernance',
  ...
  'RGPD.6': {
    ...
    descriptionLongue:
      'Consulter la <a href="https://www.cnil.fr/sites/cnil/files/atoms/files/liste-traitements-aipd-non-requise.pdf" target="_blank" rel="noopener">liste des exemptions</a>. Si votre traitement n’y figure pas, regarder s’il fait partie des traitements pour lesquels <a href="https://www.cnil.fr/fr/analyse-dimpact-relative-la-protection-des-donnees-publication-dune-liste-des-traitements-pour" target="_blank" rel="noopener">une AIPD est obligatoire</a>. Si une AIPD est nécessaire, vous pouvez la réaliser à l’aide du <a href="https://www.cnil.fr/fr/outil-pia-telechargez-et-installez-le-logiciel-de-la-cnil" target="_blank" rel="noopener">logiciel PIA</a>.<br><br>Cette mesure permet d\'identifier et dans le cas échant de réaliser une AIPD, c\'est-à-dire une Analyse d\'Impact sur la Protection des Données (AIPD). Cette analyse vise à évaluer et à atténuer les risques liés au traitement des données personnelles, surtout dans le cas de traitements susceptibles de présenter des risques élevés pour les droits et libertés des individus.',
    categorie: 'gouvernance',
