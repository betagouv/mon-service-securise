...
describe("L'objet de vue de l'annexe des mesures", () => {
  ...
  const homologation = new Homologation({
    ...
    mesuresGenerales: [{ id: 'mesure1', niveauxGravite: 'grave', categorie: 'gouvernance' }],
  }, referentiel);

  it('fournit les statuts provenant du référentiel', () => {
    const vueAnnexePDFMesures = new VueAnnexePDFMesures(homologation, referentiel);
  ...
  it("fournit les mesures par statut et par catégorie de l'homologation", () => {
    ...
    expect(donnees.mesuresParStatut).to.eql({ grave: { gouvernance: [{ id: 'mesure1' }] } });
  });
