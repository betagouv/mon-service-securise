...
const copieNomHebergement = (donnees) => {
  donnees.caracteristiquesComplementaires ||= {};
  donnees.caracteristiquesComplementaires.hebergeur = donnees.partiesPrenantes?.partiesPrenantes
    ?.find((partiePrenante) => partiePrenante.type === 'Hebergement')?.nom;

  return donnees;
};

exports.up = miseAJour(contientCaracteristiquesComplementaires, supprimeHebergeur);
