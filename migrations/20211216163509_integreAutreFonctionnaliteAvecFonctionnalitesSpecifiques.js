const DESCRIPTION_PAR_DEFAUT_AUTRES_FONCTIONNALITES =
  'Autres fonctionnalités permettant des échanges de données';
const IDENTIFIANT_AUTRE_FONCTIONNALITE = 'autre';

const deplace = (filtreAutresFonctionnalites, fonctionMiseAJour) => (knex) =>
...
const autresFonctionnalitesGeneriques = ({ donnees }) =>
  ...
  donnees.informationsGenerales.fonctionnalites.indexOf(
    IDENTIFIANT_AUTRE_FONCTIONNALITE
  ) !== -1;
...
const versFonctionnalitesSpecifiques = (informationsGenerales) => {
  ...
  informationsGenerales.fonctionnalites =
    informationsGenerales.fonctionnalites.filter(
      (f) => f !== IDENTIFIANT_AUTRE_FONCTIONNALITE
    );
...
const autresFonctionnalitesSpecifiques = ({ donnees }) =>
  ...
  donnees.informationsGenerales.fonctionnalitesSpecifiques.some(
    (f) => f.description === DESCRIPTION_PAR_DEFAUT_AUTRES_FONCTIONNALITES
  );
...
const versFonctionnalitesGeneriques = (informationsGenerales) => {
  ...
  informationsGenerales.fonctionnalitesSpecifiques =
    informationsGenerales.fonctionnalitesSpecifiques.filter(
      (f) => f?.description !== DESCRIPTION_PAR_DEFAUT_AUTRES_FONCTIONNALITES
    );
